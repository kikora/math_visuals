(function () {
  ...
  function syncFillPickerSelection(palette) {
    ...
    activeFillColorIndex = sanitizeFillIndex(activeFillColorIndex, colors.length);
  }
  ...
  function renderFillColorPicker() {
    ...
    if (instance) {
      instance.update({
        ...
        renderStyle,
        onSelect,
        getActiveValue: () => sanitizeFillIndex(activeFillColorIndex, colors.length)
      });
      syncFillPickerSelection(colors);
      return;
    }
  ...
  function loadCleanState(cleanState) {
    ...
    if (!settingsApi && cleanState.palette && typeof cleanState.palette === 'object') {
